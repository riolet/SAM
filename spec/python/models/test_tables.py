...
def test_disabled_filters():
    ...
    rows = m_table.get_table_info(filters, page=0, page_size=100, order_by=0, order_dir='asc')
    addresses = [x['address'] for x in rows]
    expected = [u'10.0.0.0/8', u'10.20.0.0/16', u'10.20.30.0/24', u'10.20.30.40/32', u'10.20.30.41/32',
                u'10.20.32.0/24', u'10.20.32.42/32', u'10.20.32.43/32', u'10.24.0.0/16', u'10.24.34.0/24',
                u'10.24.34.44/32', u'10.24.34.45/32', u'10.24.36.0/24', u'10.24.36.46/32', u'10.24.36.47/32',
