...
sample_log = [
    ...
    """<166>%ASA-6-302017: Built inbound GRE connection 7951 from inside:192.168.1.5 (192.168.1.5) (idfw_user1) to inside:192.168.1.1/55443 (192.168.10.176/23456)""",
    """<166>%ASA-6-302018: Teardown GRE connection 7951 from inside:192.168.1.5 (192.168.1.5) (idfw_user1) to inside:192.168.1.1/55443 (192.168.10.176/23456) (idfw_user2) duration 0:02:31 bytes 66429 (user3)""",
