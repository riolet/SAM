    ...
    def get_metadata(self):
        ...
        query = """
            SELECT {address_q} AS 'address'
                ...
                , COALESCE(l_out.p_s * 1.0 / l_out.sum_duration, 0) AS 'out_packets_sent'
                , COALESCE(l_out.p_r * 1.0 / l_out.sum_duration, 0) AS 'out_packets_received'
                ...
                , COALESCE(l_in.p_s * 1.0 / l_in.sum_duration, 0) AS 'in_packets_sent'
                , COALESCE(l_in.p_r * 1.0 / l_in.sum_duration, 0) AS 'in_packets_received'
