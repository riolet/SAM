const strings = {
  ...
  ,table_f_protocol1_op1: "Handles inbound"
  ...
  ,table_f_target1: "Show only hosts that "
  ...
  ,table_sum: "Filter: "
  ,table_sum_sub: "subnet"
  ,table_sum_mask: "within"
  ,table_sum_port1: "conn to "
  ,table_sum_port2: "X conn to "
  ,table_sum_port3: "conn from "
  ,table_sum_port4: "X conn from "
  ,table_sum_conn1: " conns/s (in)"
  ,table_sum_conn2: " conns/s (out)"
  ,table_sum_protocol1: "no "
  ,table_sum_protocol2: " in"
  ,table_sum_protocol3: " out"
  ,table_sum_target1: "to "
  ,table_sum_target2: "not to "
  ,table_sum_target3: "from "
  ,table_sum_target4: "not from "
  ,table_sum_tags1: "tagged "
