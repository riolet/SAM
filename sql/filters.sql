...
SELECT * FROM Links32 WHERE dest8=189 AND dest16=6 AND dest24=71 AND dest32=26;
SELECT * FROM Links WHERE dst=3171305242;
SELECT * FROM LinksIn WHERE dst_start=3171305242 AND dst_end=3171305242;

SELECT * FROM Links32 WHERE dest8=189 AND dest16=6 AND dest24=71 AND dest32=47;
SELECT * FROM Links WHERE dst=3171305263;
SELECT * FROM LinksIn WHERE dst_start=3171305242 AND dst_end=3171305263;